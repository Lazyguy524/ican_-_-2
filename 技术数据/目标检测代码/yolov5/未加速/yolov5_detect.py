...
import cv2
import argparse
from preprocess_numpy import PreProcess
from postprocess_numpy import PostProcess
from sophon_inference import SophonInference
from utils import draw_numpy, is_img
    ...
    if opt.is_video:
        ...
        while ret and frame is not None:
            ...
            vis_image = draw_numpy(frame.copy(), det[:, :4],
                                   ...
                                   classes_ids=det[:, -1],
                                   conf_scores=det[:, -2])
            save_basename = 'res_cv_{}'.format(id)
...
def parse_opt():
    ...
    parser.add_argument('--output_dir', type=str, default="yolov5n_save_without_tpu", help='output image directory')
